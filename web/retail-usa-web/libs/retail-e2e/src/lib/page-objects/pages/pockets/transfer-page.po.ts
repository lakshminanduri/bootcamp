...
export class TransferPage extends BasePage {
  ...
  readonly continueButton = this.page.locator('.btn-primary');
  readonly cancelButton = this.page.locator('.btn-link');
  ...
  readonly backButton = this.page.locator('.btn-secondary');
