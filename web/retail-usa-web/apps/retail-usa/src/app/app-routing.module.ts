            ...
            children: [
              {
                ...
                data: {
                  title: $localize`:@@loans.nav.item.title:Loans - Accounts - Retail Banking`,
              ...
              },
              {
                ...
                data: {
                  title: $localize`:@@loans-item.nav.item.title:Loan - Accounts - Retail Banking`,
                  entitlements: PERMISSIONS.canViewLoans,
                },
              },
            ],
        ...
        children: [
          {
            ...
            data: {
              title: $localize`:@@activity.nav.item.title:Activity - Transfer - Retail Banking`,
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            data: {
              title: $localize`:@@download-statements.nav.item.title:Account statements - Self services - Retail Banking`,
