...
import com.backbase.android.client.gen2.incomeexpenseanalyzerclient1.api.CategoryTotalsApi
...
fun ModelBankClientDefinitions(
    additionalDependencies: ModuleDeclaration = {}
) = module {

    ModelBankAdditionalDependencies()(this)
